...
import { ArrowDown, FileText, CheckCircle2, Zap, ShieldCheck } from 'lucide-react'
          ...
          {products.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {products.map((product) => {
                ...
                return (
                  <div key={product.id} className="comic-card flex flex-col h-full bg-white overflow-hidden">
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between">
                      <div>
                        {product.category && (
                          <span className="text-[10px] font-bold text-[#E63946] uppercase tracking-wider block mb-1">
                            {product.category}
                          </span>
                        )}
